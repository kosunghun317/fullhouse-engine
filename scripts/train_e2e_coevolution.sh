...
HEURISTIC_MATCHES_PER_GENERATION="${HEURISTIC_MATCHES_PER_GENERATION:-24}"
HEURISTIC_HANDS="${HEURISTIC_HANDS:-200}"
EVAL_SEEDS="${EVAL_SEEDS:-6}"
EVAL_HANDS="${EVAL_HANDS:-180}"
