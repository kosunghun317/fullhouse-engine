...
PROMOTION_SEED_COUNT="${PROMOTION_SEED_COUNT:-64}"
STRONG_SEED_COUNT="${STRONG_SEED_COUNT:-64}"
MOCK_SEED_COUNT="${MOCK_SEED_COUNT:-64}"
FINAL_SEED_COUNT="${FINAL_SEED_COUNT:-100}"
